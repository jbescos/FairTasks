...
public class GroupsRepository {
    ...
    public List<Group> findByEmail(String email) {
        return jdbcTemplate.query("SELECT * FROM GROUPS WHERE GROUP_NAME IN (SELECT GROUP_NAME FROM GROUPS WHERE EMAIL = ?) ORDER BY GROUP_NAME, EMAIL", new Object[]{email}, new GroupMapper());
    }
